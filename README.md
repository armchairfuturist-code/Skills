...
- `market_pulse.py` — the full thirteen-axis regime read in one run: Shiller CAPE, Buffett Indicator, S&P/M2, VIX, high-yield spread, the yield curve, a limited SMH high-low-range proxy, Polymarket recession/rate-hike odds, 60-day equity and equity–bond correlations, a thin 2-state HMM check, plus the six structural axes (debt-to-GDP and interest/revenue, DXY proxy, 10y TIPS real yield, gold, M2, Fed balance sheet, BTC vs 200-week MA, SPY 200-day/200-week trend). The proxy is not treated as a reversal, flash-crash, market-wide, or AI-attribution measure.
