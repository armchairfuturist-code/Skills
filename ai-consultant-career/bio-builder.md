# Bio & Positioning Builder (for Applicants)

> Reference file. Load only when writing resume summaries, cover letter openings, interview introductions, or LinkedIn positioning. Context pointer: *Resume & Cover Letter branch: see reference for formulas and examples.*

---

## Headline Formulas (for Resume Summary & LinkedIn)

### The 4 Valid Headline Structures
...
## Tone by Audience (for Applicants)

| Audience | Keywords to lead with | Keywords to avoid | Cadence |
|---|---|---|---|
...
## Platform-Specific Constraints (for Applicants)

| Platform | Max chars | Key rule |
|---|---|---|
| LinkedIn headline | 220 | Keywords front-loaded. GitHub or "shipped" in first 120 chars. |
| LinkedIn About | 2,600 | First 200 chars must include GitHub link and hook. Last 200 chars must have a CTA. |
| Resume summary | 2-3 lines | Three bolts stacked. No full sentences beyond the bolts. |
| Cover letter (email) | ~200 words | GitHub link in first paragraph. One page max. |
| Portfolio hero | 1-2 lines | Headline + sub-line with GitHub link. Nothing else. |
| Interview intro (verbal) | 60-90 seconds | "Tell me about yourself": lead with shipped work, end with why *this* company. |
